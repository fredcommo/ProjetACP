...
# Upload Normalized GE-IlluminaHiSeq-mRNAreadCounts
ent <- loadEntity('syn346081')
...
columnId <- which.max(columnMatchTotals > 0)	#[1]
columnMatchTotals[columnId]
metaDat <- metaDat[match(colnames(eset), metaDat[,columnId]),]
