...
.generateRandom <- function(Data, p){
  ...
  output <- lapply(1:p,
                   function(i){ if(i%%ceiling(p/10) == 0) cat(x, '\t')
...
png(file = paste0('/Users/fredcommo/Documents/MyProjects/Simulations/Lee_simulated_SdevMeans_distrib.png'), width = 800, height = 800)
par(cex.main = 2.5, cex.lab = 1.75, cex.axis = 1.25)
smoothScatter(M, log10(S))
points(whiteM, log10(whiteS), pch = 19, cex = 0.5, col = 'grey75')
